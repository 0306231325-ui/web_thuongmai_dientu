<div class="container-fluid pt-5 pb-3">
                    ...
                    <div class="product-info text-center px-2 py-3 d-flex flex-column justify-content-between flex-grow-1">
                        ...
                        <div class="product-info-bottom mt-2">
                            <small class="text-muted">
                                Thương hiệu: <strong>{{ $sp->thuongHieu->TenThuongHieu ?? 'Khác' }}</strong>
                            </small>
  ...
  <!-- day la khu vuc san pham ban chay cua Nhanh phu -->
    <div class="container-fluid pt-5 pb-3">
    <h2 class="section-title position-relative text-uppercase mx-xl-5 mb-4">
        ...
        @foreach($bestSellers as $sp)
            <div class="col-lg-3 col-md-4 col-sm-6 pb-4">
                <div class="product-item bg-light h-100 d-flex flex-column">
                    ...
                    <div class="product-img-fixed">
                        <img src="{{ $sp->anh_hien_thi }}" alt="{{ $sp->TenSanPham }}">
                        <div class="product-action">
                            <a class="btn btn-outline-dark btn-square" href="{{ route('sanpham.chitiet', $sp->Slug) }}">
                                <i class="fa fa-shopping-cart"></i>
                            </a>
                            <a class="btn btn-outline-dark btn-square" href="{{ route('yeuthich.store', $sp->MaSanPham) }}">
                    ...
                    <div class="product-info text-center px-2 py-3 d-flex flex-column justify-content-between flex-grow-1">
                        ...
                        <div class="mt-1">
                            <small class="text-secondary">
                                <i class="fa fa-eye"></i> {{ number_format($sp->LuotXem) }} lượt xem
                            </small>
                        </div>
                        ...
                        <div class="product-info-bottom mt-2">
                            ...
                            <div class="d-flex align-items-center justify-content-center">
                                @for($i = 1; $i <= 5; $i++)
                                    <small class="fa fa-star {{ $i <= floor($sp->diem_trung_binh) ? 'text-primary' : 'text-muted' }} mr-1"></small>
                                @endfor
                                <small class="ml-1">({{ $sp->danhGias->count() }})</small>
                            </div>
                        </div>
                    </div>
                </div>
